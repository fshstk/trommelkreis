	...
	<div class="card-body">
		...
		<ul>
			...
			<li>
				...
				Teilnehmer<small class="text-muted">/in</small> hat einen gewissen Zeitrahmen (in der Regel 60/90/120
				Minuten), um diese Vorgabe in einen kurzen Track zu verwandeln.
			</li>
...
<div class="card">
	<div class="card-body">
		...
		<p>
			...
			statt. In der Regel ist die Deadline für das Hochladen um 22:00 Uhr, und das gemeinsame Hören um
			22:30 Uhr auf dem Discord Server der
			<a href="http://www.klangwerkstatt-graz.at/">Klangwerkstatt Graz</a>.
		</p>
		<p>
			Die Challenge wird meistens pünktlich zu Beginn auf der
			<a href="/upload">Mitmachen</a> Seite veröffentlicht. Zusätzlich gibt es in unserer WhatsApp Gruppe
			Updates zu zukünftigen Terminen, und die Möglichkeit, jeder Zeit Fragen zu stellen.
		</p>
		<p>
...
<div class="card">
	<div class="card-body">
		...
		<p>
			...
			so ausgelegt, dass du dafür gar kein fortgeschrittenes Wissen in Produktion oder Musiktheorie brauchst.
		</p>
		...
		<p>
			Wir sind eine <em>no-judge-Zone</em>. Wie gut oder professionell dein Track am Schluss klingt,
